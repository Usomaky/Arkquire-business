    ...
    <section class="w-full bg-[#F7FFFC] font-body">
        <div class="w-full md:min-h-[28rem] pb-4 bg-primary-100">
            ...
            <div class="w-full mt-8 space-y-4">
                <h2
                    class="text-3xl font-semibold text-center md:text-4xl lg:text-5xl font-head"
                >
                    Put business on sale <br /><span class="text-primary-400"
                        >with Arkquire</span
                    >
                </h2>
                <p class="text-sm text-center md:text-lg">
                    We will help you cash-in on your business
                </p>
                <!-- <pre class="text-xs">
                    {{ form }}
                </pre> -->
        ...
        <div class="flex justify-center w-full mb-8">
            <div class="flex justify-center w-full md:relative md:-top-28">
                <form
                    ...
                    class="p-4 md:p-8 w-full min-h-[28rem] max-w-xl bg-white rounded-lg shrink-0 border-b relative"
                >
                    <img
                        src="/images/pattern_leaf.svg"
                        class="w-[20rem] hidden lg:block h-auto rotate-[220deg] opacity-50 absolute -top-48 -left-56"
                        alt="image"
                    />
                    <img
                        src="/images/pattern_naira.svg"
                        class="w-[15rem] hidden lg:block h-auto absolute opacity-50 -right-60 -top-48"
                        alt="image"
                    />
                    <header class="w-full mb-4">
                        ...
                        <small class="block mb-2 text-neutral-700"
                            >Kindly provide more information about your
                            business</small
                        >
                        <Timeliner
                            :timelines="timelines"
                    ...
                    <section v-show="currentTimeline === 0">
                        <div
                            class="grid w-full grid-cols-1 gap-2 mb-2 md:grid-cols-2"
                        >
                                ...
                                <Dropdown
                                    @change="
                                        form.business_type === 'digital' &&
                                            ...
                                            (form.country = ' ') &&
                                            (form.landmark = ' ');
                                        'business_type' in form.errors &&
                                            form.clearErrors('business_type');
                                    "
                                    v-model="form.business_type"
                                    :class="
                                        form.errors.business_type && 'p-invalid'
                                    "
                                    :options="[
                            ...
                            <div class="w-full">
                                ...
                                <Dropdown
                                    @change="
                                        'category_id' in form.errors &&
                                            form.clearErrors('category_id')
                                    "
                                    v-model="form.category_id"
                                    :class="
                                        form.errors?.category_id && 'p-invalid'
                                    "
                                    :options="categories"
                        ...
                        <div
                            class="grid w-full grid-cols-1 gap-2 mb-4 md:grid-cols-2"
                        >
                            <div class="w-full">
                                ...
                                <InputNumber
                                    ...
                                    "
                                    v-model="form.age"
                                    :class="form.errors.age && 'p-invalid'"
                                    class="w-full p-inputtext-sm"
                                    inputId="expiry"
                                    :suffix="form.age > 1 ? ' years' : ' year'"
                                />
                                <small
                    ...
                    <section v-show="currentTimeline === 1">
                        ...
                        <div class="w-full mb-2">
                            ...
                            <InputText
                                ...
                                "
                                :class="form.errors?.address && 'p-invalid'"
                                class="w-full"
                        ...
                        <div
                            v-show="form.business_type !== 'digital'"
                            id="addressFields"
                        >
                            <div class="w-full mb-2">
                                ...
                                <InputText
                                    ...
                                    "
                                    :class="form.errors?.lga && 'p-invalid'"
                                    class="w-full"
                                    v-model="form.lga"
                                    size="small"
                                />
                                <small
                                    v-if="form.errors?.lga"
                                    class="text-xs text-red-400"
                                >
                                    {{ form.errors?.lga }}
                                </small>
                            ...
                            <div class="w-full mb-2">
                                ...
                                <InputText
                                    ...
                                    "
                                    :class="form.errors?.city && 'p-invalid'"
                                    class="w-full"
                                    v-model="form.city"
                                    size="small"
                                />
                            ...
                            <div class="w-full mb-2">
                                ...
                                <InputText
                                    @input="
                                        'state' in form.errors &&
                                            form.clearErrors('state')
                                    "
                                    :class="form.errors?.state && 'p-invalid'"
                                    class="w-full"
                                    v-model="form.state"
                                    size="small"
                                />
                            ...
                            <div class="w-full mb-2">
                                ...
                                <InputText
                                    @input="
                                        'country' in form.errors &&
                                            form.clearErrors('country')
                                    "
                                    :class="form.errors?.country && 'p-invalid'"
                                    class="w-full"
                            ...
                            <div class="w-full mb-2">
                                <label class="text-xs"
                                    >What is the nearest landmark in your
                                    business location?</label
                                >
                                <InputText
                                    @input="
                                        'landmark' in form.errors &&
                                            form.clearErrors('landmark')
                                    "
                                    :class="
                                        form.errors?.landmark && 'p-invalid'
                                    "
                                    class="w-full"
                                    v-model="form.landmark"
                                    placeholder="10mins drive from Asaba International Airport"
                                    size="small"
                                />
                                <small
                                    v-if="form.errors?.landmark"
                                    class="text-xs text-red-400"
                                >
                        ...
                        >
                            ...
                            <div class="w-full">
                                ...
                                <Dropdown
                                    @change="
                                        'property_id' in form.errors &&
                                            form.clearErrors('property_id')
                                    "
                                    v-model="form.property_id"
                                    :class="
                                        form.errors?.property_id && 'p-invalid'
                                    "
                                    :options="properties"
                            ...
                            <div class="w-full">
                                ...
                                <Dropdown
                                    @change="
                                        'staffs' in form.errors &&
                                            form.clearErrors('staffs')
                                    "
                                    v-model="form.staffs"
                                    :class="form.errors?.staffs && 'p-invalid'"
                                    :options="[
                                        '1 - 20',
                                        '20 - 40',
                                        '40 - 60',
                        ...
                        <div class="w-full mb-8">
                            ...
                            >
                                ...
                                >
                                    <template
                                        #item="{ element: image, index: key }"
                                    >
                                        <div
                                            :style="`background-image: url(${createURL(
                                                image
                                            )});`"
                            ...
                            <p class="text-sm tracking-wide text-neutral-600">
                                <small
                                    >.jpg, .png, size limit per photo: 3MB,
                                    photos limit: 8</small
                                >
                            </p>
                    ...
                    <section v-show="currentTimeline === 2">
                        <div class="w-full mb-2">
                            ...
                            <SelectButton
                                @change="
                                    'transaction_type' in form.errors &&
                                        form.clearErrors('transaction_type')
                                "
                                v-model="form.transaction_type"
                                :class="
                                    form.errors?.transaction_type && 'p-invalid'
                                "
                        ...
                        >
                            ...
                            <Calendar
                                ...
                                "
                                :class="form.errors?.ends && 'p-invalid'"
                        ...
                        <div class="w-full mb-2">
                            <label class="text-xs"
                                >What is your profit margin ?</label
                            >
                            <InputNumber
                                @input="
                                    'profit_margin' in form.errors &&
                                        form.clearErrors('profit_margin')
                                "
                                v-model="form.profit_margin"
                                :class="
                                    form.errors?.profit_margin && 'p-invalid'
                                "
                                class="w-full p-inputtext-sm"
                            ...
                            />
                            <small
                                v-if="form.errors?.profit_margin"
                                class="text-xs text-red-400"
                            >
                        ...
                        <div class="w-full mb-8">
                            ...
                            <InputNumber
                                @input="
                                    'price' in form.errors &&
                                        form.clearErrors('price')
                                "
                                v-model="form.price"
                                :class="form.errors?.price && 'p-invalid'"
                                class="w-full p-inputtext-sm"
                                inputId="currency-ng"
                                mode="currency"
                                currency="NGN"
                    ...
                    <section v-show="currentTimeline > 2">
                        <div
                            class="w-full min-h-[15rem] flex flex-col gap-y-4 items-center justify-center"
                        >
                            <div class="w-20">
                                <img
                            ...
                            <p class="text-center text-neutral-700">
                                ...
                                but under review. We will notify you once it is
                                approved.
                            </p>
                            <div
