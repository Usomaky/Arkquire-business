    ...
    <section class="w-full wrapper mt-16">
        <header class="w-full flex items-start justify-between mb-8">
            <div>
                ...
                <small> These are the list of businesses on auction </small>
            </div>
        </header>
        ...
        <div
            v-show="businesses?.data?.length > 0"
            class="w-full mt-4 overflow-auto scrollbar-hide md:scrollbar-default col-span-12 flex md:justify-end"
        >
